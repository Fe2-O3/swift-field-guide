...
| File | Use it for |
|---|---|
| `migration.md` | rollout order, build settings, migration guardrails, continuation/delegate bridging |
...
| File | Use it for |
|---|---|
| `hotspots.md` | grep targets for a fast first pass over unfamiliar code |
| `bug-patterns.md` | catalog of common failure modes, for scanning during review |
| `diagnostics.md` | strict-concurrency compiler errors mapped to ordered fixes |
...
- "I need to review someone else's concurrency code" → `../SKILL.md#review-mode`, then `hotspots.md` and `bug-patterns.md`
